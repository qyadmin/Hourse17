    ...
    public sealed class HTTPRequest : System.Collections.IEnumerator
    {
        ...
        internal bool SendOutTo(Stream stream)
        {
            ...
            try
            {
                ...
                string host = HasProxy && Proxy.SendWholeUri ? CurrentUri.OriginalString : CurrentUri.PathAndQuery;

                HTTPManager.Logger.Information("HTTPConnection", string.Format("Sending {0} request to {1}", MethodType.ToString().ToUpper(), host));
